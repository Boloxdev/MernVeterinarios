...
const Registrar = () => {
    ...
    const [ repetirPassword, setReptirPassword ] = useState('');
    ...
    <>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
            <form onSubmit={handleSubmit}>
               {msg && <Alerta alerta={alerta} />} 
                ...
                <div className='my-5'>
                        ...
                        <input type="password" placeholder='Repite tu Password' className='border w-full p-3 mt-3 bg-gray-50 rounded-xl' value={repetirPassword} onChange={e => setReptirPassword(e.target.value)} />
                </div>
            ...
            <nav className='mt-10 lg:flex lg:justify-between'>
                <Link to="/" className='block text-center my-5 text-gray-500'>¿Tienes una cuenta? Inicia sesión</Link>
                <Link to="/olvide-password" className='block text-center my-5 text-gray-500'>¿Olvidaste tu contraseña? Recuperar contraseña</Link>
            </nav>
        </div>
    </>
  )
